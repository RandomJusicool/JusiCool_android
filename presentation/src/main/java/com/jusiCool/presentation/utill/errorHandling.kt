...
import com.jusiCool.domain.util.exception.BadRequestException
import com.jusiCool.domain.util.exception.ConflictException
import com.jusiCool.domain.util.exception.ForBiddenException
import com.jusiCool.domain.util.exception.NeedLoginException
import com.jusiCool.domain.util.exception.NotAcceptableException
import com.jusiCool.domain.util.exception.NotFoundException
import com.jusiCool.domain.util.exception.ServerException
import com.jusiCool.domain.util.exception.TimeOutException
import com.jusiCool.domain.util.exception.UnauthorizedException
