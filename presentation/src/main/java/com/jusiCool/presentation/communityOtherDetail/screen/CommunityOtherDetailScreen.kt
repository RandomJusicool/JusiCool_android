package com.jusiCool.presentation.communityOtherDetail.screen
...
const val communityOtherDetailRoute = "communityOtherDetailRoute"

fun NavController.navigateToCommunityDetail() {
    this.navigate(communityOtherDetailRoute)
}
...
private fun CommunityDetailPre() {
    CommunityOtherDetailRoute(popUpBackStack = { /*TODO*/ }) {
