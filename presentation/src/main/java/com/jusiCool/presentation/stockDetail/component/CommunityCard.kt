...
import com.example.design_system.icon_image.image.SpeechBubbleImage
...
fun CommunityCard(
    ...
    Column(
        ...
        Row(
            ...
            RightChevronIcon(modifier = Modifier.clickableSingle { navigateToCommunity() })
        }
    }
}
...
fun CommunityCardPreview() {
    CommunityCard(navigateToCommunity = {})
}