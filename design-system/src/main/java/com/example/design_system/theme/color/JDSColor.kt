package com.example.design_system.theme.color
...
object JDSColor: ColorTheme() {
    ...
    override val GRAY700 = Color(0xFF4F4F51)
    override val GRAY600 = Color(0xFF666669)
    ...
    override val GRAY2 = Color(0xFFB4B5B7)
    override val GRAY1 = Color(0xFFB8B8B8)
